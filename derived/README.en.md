...
## Game data (used by writers, the editor, and the simulator)
...
| [`builder_slots.json`](builder_slots.json) | How many peasants can build each building simultaneously. It is considered bypassing the perimeter of the collision mask with a step `gc_BuilderDist = 1.0`. Used in [`docs/reports/economy/builder_slots.md`](../docs_en/reports/economy/builder_slots.md) and in the editor. | [`compute/compute_builder_slots.py`](../compute/compute_builder_slots.py) |
...
## Engine reverse engineering (used by `internals_en/`)
...
- **Ready for people help** - in [`../docs/reference/`](../docs_en/reference/),
[`../docs/reports/`](../docs_en/reports/), [`../docs/recon/`](../docs_en/recon/).
* Documentation of the engine** - in [`../internals/`](../internals_en/) (engine, scripts, data).
