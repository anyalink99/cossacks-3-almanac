...
- **Эмпирическая скорость крестьянина** в тайлах за g-сек — нужна для замены статического `walk_overhead = 0.30` физическим расчётом. См. [`../recon/world/peasant_extraction.md`](../recon/world/peasant_extraction.md) §9.
