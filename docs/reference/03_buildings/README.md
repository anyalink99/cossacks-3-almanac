...
**[Общие постройки (по кластерам)](#общие-постройки-по-кластерам)**
  ...
  - [wga — Деревянные ворота](#wga--деревянные-ворота)
  - [wwa — Палисад](#wwa--палисад)
...
| Содержание | `consume[gold] = 500` → **0.8 gold / g-sec** (≈ 67 / real-мин @ fast) | формула `× 32 / 20000`, при `gold = 0` башня молча перестаёт стрелять |
...
| Здание (cluster) | Нации | HP | Время (g-сек) | cost% | F | W | S | G | I | C | Доп. |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Каменные ворота** `eursga` | aus, bav, den, eng, fra, hun, net, pie, pol, por, pru, sax, sco, spa, swe, swi, ven | 32000 | 90.0 | 0 | 0 | 0 | 50 | 0 | 0 | 0 | содержание {"stone": 250} |
| **Каменные ворота** `russga` | rus | 32000 | 200.0 | 0 | 0 | 0 | 60 | 0 | 0 | 0 | содержание {"stone": 200} |
| **Каменные ворота** `tursga` | alg, tur | 32000 | 120.0 | 0 | 0 | 0 | 60 | 0 | 0 | 0 | содержание {"stone": 150} |

### wga — Деревянные ворота

| Здание (cluster) | Нации | HP | Время (g-сек) | cost% | F | W | S | G | I | C | Доп. |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Деревянные ворота** `ukrwga` | alg, aus, bav, den, eng, fra, hun, net, pie, pol, por, pru, rus, sax, sco, spa, swe, swi, tur, ukr, ven | 1500 | 5.62 | 0 | 0 | 10 | 0 | 0 | 0 | 0 | содержание {"wood": 32} |

### wwa — Палисад

| Здание (cluster) | Нации | HP | Время (g-сек) | cost% | F | W | S | G | I | C | Доп. |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Частокол** `ukrwwa` | alg, aus, bav, den, eng, fra, hun, net, pie, pol, por, pru, rus, sax, sco, spa, swe, swi, tur, ukr, ven | 1500 | 5.62 | 0 | 0 | 10 | 0 | 0 | 0 | 0 | содержание {"wood": 32} |
