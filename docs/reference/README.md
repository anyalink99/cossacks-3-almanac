...
- **Cheatsheet'ы наций** — отдельная страница на каждую из 21 играбельных, с уникальными юнитами, аномалиями и доступом к 18 веку.
- **Сравнения** — side-by-side таблицы по классам юнитов (все пикинёры, все мушкетёры 18 в. и т. д.).
...
| Глава | О чём |
|---|---|
| [01_economy.md](01_economy.md) | Добыча ресурсов: формулы, `eff`, шахты, поля, голод и upkeep, рыбалка. |
| [02_combat.md](02_combat.md) | Бой: формула урона, хедшот, формации, рассеяние, AoE, скорости, контр-матрица. |
| [03_buildings.md](03_buildings.md) | Все здания (национальные и общие), цены, footprint. |
| [04_units.md](04_units.md) | Все юниты по классам — пехота, кавалерия, артиллерия, корабли. |
| [05_upgrades.md](05_upgrades.md) | Все апгрейды, сгруппированы по месту исследования. |
| [06_market.md](06_market.md) | Рынок: курсы обмена, преимущество первого хода, деградация цен. |
| [07_naval.md](07_naval.md) | Морской флот: порт, корабли, транспорт, рыболов, DLC-юниты. |

**Указатели по объектам:**

- [`nations/`](nations/README.md) — по одному cheatsheet'у на каждую из 21 наций (что у неё уникального).
...
`delivered = floor(portion × eff / 100)`. `eff` стартует со 100; апгрейды (`mill.X`, `aca.X`, `bla.X`) добавляются **аддитивно**. Подробности — [01_economy.md](01_economy.md).
