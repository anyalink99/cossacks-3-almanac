...
Какой апгрейд на что влияет. Сводка по `itype` (расшифровано в [главе «Апгрейды»](../05_upgrades/README.md)). Цены даны для базовой нации (отличаются по нациям — см. [главу «Апгрейды»](../05_upgrades/README.md)).
...
Полный список — в [главе «Апгрейды»](../05_upgrades/README.md) (~4500 строк, по местам).
