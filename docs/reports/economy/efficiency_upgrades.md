...
**Производный** файл (расчётный, не извлечение). Считается из `docs/data.json` скриптом [`compute/compute_efficiency_upgrades.py`](../../compute/compute_efficiency_upgrades.py).
