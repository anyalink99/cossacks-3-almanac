...
| `pandur` | Пандур | 5.50 | 10.9 | **15.3** | 40 | 15 | 10 | 1 | — |
...
| Юнит | имя | Время (g-сек) | темп (units / g-мин) | темп (units / real-мин @ fast) | F | G | I | ферма | расход еды |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `drummer` | Барабанщик 17в. | 5.00 | 12.0 | **16.8** | 60 | 20 | 0 | 1 | — |
...
| Юнит | имя | Время (g-сек) | темп (units / g-мин) | темп (units / real-мин @ fast) | F | G | I | ферма | расход еды |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `priest` | Капеллан | 20.00 | 3.0 | **4.2** | 60 | 25 | 0 | 1 | — |
...
| Юнит | имя | Время (g-сек) | темп (units / g-мин) | темп (units / real-мин @ fast) | F | G | I | ферма | расход еды |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `bagpiper` | Волынщик | 7.00 | 8.6 | **12.0** | 120 | 20 | 0 | 1 | — |
| `grenadier` | Гренадер | 6.00 | 10.0 | **14.0** | 80 | 60 | 40 | 1 | 36 |
| `highlander` | Шотландский стрелок | 6.50 | 9.2 | **12.9** | 90 | 25 | 10 | 1 | 39 |
| `musketeer18` | Мушкетер 18в. | 4.50 | 13.3 | **18.7** | 50 | 40 | 40 | 1 | — |
| `officer18` | Офицер 18в. | 6.00 | 10.0 | **14.0** | 50 | 200 | 10 | 1 | — |
| `pikeman18` | Пикинер 18в. | 1.25 | 48.0 | **67.2** | 30 | 2 | 0 | 1 | — |
...
| Юнит | имя | Время (g-сек) | темп (units / g-мин) | темп (units / real-мин @ fast) | F | G | I | ферма | расход еды |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `chasseur` | Егерь | 7.50 | 8.0 | **11.2** | 50 | 45 | 15 | 1 | — |
| `drummer18` | Барабанщик 18в. | 6.00 | 10.0 | **14.0** | 50 | 30 | 0 | 1 | — |
| `grenadier` | Гренадер | 6.00 | 10.0 | **14.0** | 80 | 60 | 40 | 1 | 36 |
| `musketeer18` | Мушкетер 18в. | 4.50 | 13.3 | **18.7** | 50 | 40 | 40 | 1 | — |
| `officer18` | Офицер 18в. | 6.00 | 10.0 | **14.0** | 50 | 200 | 10 | 1 | — |
...
| `musketeer18` | Мушкетер 18в. | 4.50 | 13.3 | **18.7** | 50 | 40 | 40 | 1 | — |
| `officer18` | Офицер 18в. | 6.00 | 10.0 | **14.0** | 50 | 200 | 10 | 1 | — |
| `pandurhun` | Секей | 6.50 | 9.2 | **12.9** | 30 | 25 | 10 | 1 | — |
| `pikeman18` | Пикинер 18в. | 1.25 | 48.0 | **67.2** | 30 | 2 | 0 | 1 | — |
...
| Юнит | имя | Время (g-сек) | темп (units / g-мин) | темп (units / real-мин @ fast) | F | G | I | ферма | расход еды |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `padre` | Падре | 25.00 | 2.4 | **3.4** | 50 | 40 | 0 | 1 | — |
...
| `drummer18` | Барабанщик 18в. | 6.00 | 10.0 | **14.0** | 50 | 30 | 0 | 1 | — |
| `grenadier` | Гренадер | 6.00 | 10.0 | **14.0** | 80 | 60 | 40 | 1 | 36 |
| `jagerpor` | Доброволец | 2.25 | 26.7 | **37.3** | 30 | 2 | 5 | 1 | — |
| `musketeer18` | Мушкетер 18в. | 4.50 | 13.3 | **18.7** | 50 | 40 | 40 | 1 | — |
| `officer18` | Офицер 18в. | 6.00 | 10.0 | **14.0** | 50 | 200 | 10 | 1 | — |
| `pikeman18` | Пикинер 18в. | 1.25 | 48.0 | **67.2** | 30 | 2 | 0 | 1 | — |
...
| Юнит | имя | Время (g-сек) | темп (units / g-мин) | темп (units / real-мин @ fast) | F | G | I | ферма | расход еды |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `pope` | Поп | 20.00 | 3.0 | **4.2** | 40 | 20 | 0 | 1 | — |
...
| `drummer18` | Барабанщик 18в. | 6.00 | 10.0 | **14.0** | 50 | 30 | 0 | 1 | — |
| `grenadier` | Гренадер | 6.00 | 10.0 | **14.0** | 80 | 60 | 40 | 1 | 36 |
| `jagerswi` | Егерь | 8.50 | 7.1 | **9.9** | 40 | 70 | 20 | 1 | — |
| `musketeer18` | Мушкетер 18в. | 4.50 | 13.3 | **18.7** | 50 | 40 | 40 | 1 | — |
| `officer18` | Офицер 18в. | 6.00 | 10.0 | **14.0** | 50 | 200 | 10 | 1 | — |
| `pikeman18` | Пикинер 18в. | 1.25 | 48.0 | **67.2** | 30 | 2 | 0 | 1 | — |
...
3. **При нехватке farm производство останавливается** — здание попытается списать ресурс, но юнит не выйдет, прогресс заморожен.
4. **N зданий = N × rate.** 5 пехотных казарм = 5 × ~13 мушкетёр/мин @ fast = ~65 мушкетёров/мин.
