...
Реверс-инжиниринг по `data/scripts/lib/miscext.script` (функции
`_misc_CheckCapture`, `_misc_ChangePlayer`). Все пути ниже — относительно
`data/` в установке Cossacks 3.
