...
**Числа для Tiny + Highlands + Land** (источник: [`compute/compute_map_resources.py`](../compute/compute_map_resources.py), отчёт в [`docs/reports/map/map_resources.md`](../docs/reports/map/map_resources.md)):
