...
| Здание | Нации | Прочность | Время постройки, кадров | Дерево | Камень | Золото | Можно захватить |
|---|---|---:|---:|---:|---:|---:|---|
| Дипломатический центр | Австрия, Франция, Англия, Испания, Польша, Швеция, Пруссия, Венеция, Нидерланды, Дания, Португалия, Пьемонт, Саксония, Бавария, Венгрия, Швейцария, Шотландия | 4500 | 1000 | 4900 | 1700 | 0 | Нет |
| Дипломатический центр | Россия | 6500 | 1000 | 7900 | 3700 | 0 | Нет |
| Дипломатический центр | Украина | 5000 | 1000 | 3900 | 2700 | 0 | Нет |
| Дипломатический центр | Турция, Алжир | 5500 | 1000 | 4600 | 2020 | 0 | Нет |

Для строительства нужна Академия. **Дипломатический центр захватить
нельзя**, а предшествующую ему Академию — можно. Локализация также
указывает, что игрок может построить только один такой центр; место
проверки этого ограничения пока не найдено.

---

## Кого можно нанять

В **каждой** нации доступны восемь наёмников: Лёгкий пехотинец,
Рундашир, Гренадер, Лучник, Сечевой казак, Драгун XVIII века, а также
Турецкий лучник и Лёгкий кавалерист из дополнения `Early Bird` [^5].
...
| Наёмник | Прочность | Время найма, кадров | Цена, золото | Содержание золотом | Рост цены, % | Оружие (урон / дальность / тип) |
|---|---:|---:|---:|---:|---:|---|
| **Лёгкий пехотинец** | 50 | 40 | 4 | 4 | 100 | меч 16, дальность 50 пикселей |
| **Рундашир** | 75 | 48 | 12 | 20 | 100 | меч 6, дальность 50 пикселей |
| **Лучник** | 20 | 40 | 15 | 16 | 100,5 | стрела 25 / огнестрел 100, дальность 700/750 |
| **Турецкий лучник** | 20 | 40 | 15 | 16 | 100,5 | то же |
| **Гренадер** | 30 | 48 | 25 | 60 | 100,5 | пика 30 / пуля 16 (дальность 800) / граната 200 (дальность 400) |
| **Сечевой казак** | 150 | 80 | 60 | 150 | 100,5 | конная сабля 8, дальность 20 пикселей |
| **Драгун XVIII века** | 100 | 64 | 120 | 120 | 102 | конная пуля 18, дальность 800 |
| **Лёгкий кавалерист** | 100 | 64 | 120 | 120 | 102 | то же |
...
пищу на содержание (см. [голод и содержание армии](../world/economy/hunger_and_rebellion.md)).
...
`floor(base × (costpercent/100)^N)` (см. [рост цен](../../reports/economy/scaling_prices.md)).
...
Обработчик — `_player_ProcessResourceConsume`
в `player.script` [^10].
...
[Настройки матча](../../reports/map/lobby_settings.md#marketdip--рынок-и-дипцентр);
поведение движка — [Как настройки матча влияют на игру](../world/map/game_settings.md) §3.5.
...
- Обычные юниты расходуют пищу по формуле
  ...
  (см. [голод и содержание армии](../world/economy/hunger_and_rebellion.md)).
  Наёмники с `bnohungry` пищу не расходуют.
...
| 3 | Частота проверок бунта в реальном времени: обработчик состояния бездействия срабатывает раз за один такт обработки. | Сверить с [разбором тиков и игрового времени](../../../internals/engine/ticks_and_subticks.md) §3. При интервале около 135 мс наёмники на сложном уровне переходят меньше чем за секунду; при 100 мс — примерно за полсекунды. |
