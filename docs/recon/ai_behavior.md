...
Реверс-инжиниринг по `data/scripts/` в установке Cossacks 3.
...
- **«Сложность» — это множитель скорости постройки и найма**, ничего
  больше: easy 30% / normal 50% / hard 75% / very hard 100% / impossible
  125%. Стартовых ресурсов ИИ **не получает** ни на какой сложности.
- **Build order rule-based** и нация-зависимый. Нет ML, нет рандома —
  ...
  склад; есть aca → исследуй cen.1 → ставь ba2; и т. д.).
