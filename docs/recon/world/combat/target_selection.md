...
[Как ведут себя стрелковые юниты §4](ranged_units_behavior.md#4-штраф-к-дальности-при-движении-standtime).
...
[Как ведут себя стрелковые юниты §7](ranged_units_behavior.md#7-high-ground--бонус-с-возвышенности).
...
3. Урон по области получает каждый, кто оказался в радиусе взрыва (см.
   [Как рассчитывается урон §6.5](combat_damage_pipeline.md)).
...
описано в
[Как ведут себя стрелковые юниты §1-2](ranged_units_behavior.md#1-standground-vs-обычный-режим).
...
- **Диверсант под управлением ИИ целит в максимальный урон.** В
  ...
  не «обычный» ИИ; см. [Как играет компьютер](../../systems/ai_behavior.md), раздел
  «Открытые вопросы».
...
[Как рассчитывается урон §5](combat_damage_pipeline.md)) [^32]. Формула:
...
скриптах нет. См. также [Как захватываются здания и юниты](../economy/capture_mechanics.md)
§7.
...
См. также [Как рассчитывается урон §8](combat_damage_pipeline.md)
