...
**Вывод для расчётов:** все формулы ниже даны в **игровых секундах**. Для
game speed 2 умножайте rate на 1.4 чтобы получить real-time rate, или
делите длительности на 1.4.
