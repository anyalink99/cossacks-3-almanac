...
[`reports/map/lobby_settings.md`](../../../reports/map/lobby_settings.md#capture--правила-захвата).
Взаимодействие с мирным временем (`peacetime`) и владением территорией
описано в [`game_settings.md`](../map/game_settings.md) §3.4.
...
- **Исключение:** во время стройки (когда `arg_obj.bbuilt=False`), любое
  ...
  можно захватить** обычным пехотинцем, подойдя ближе чем на четыре тайла.
...
здания** на расстояние менее 4,013 тайла по евклидовой метрике. Если
