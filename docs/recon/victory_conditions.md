...
* **Peacetime:** `gc_mapsettings_peacetime_*` (`dmscript.global:1055-1066`) — 0/10/15/20/30/45/60/90/120/180/240 мин. Это запрет атаки в первые N мин, не таймер-конца игры. Полная таблица + механика — [`game_settings.md`](game_settings.md) §3.4.
