<a id="улучшения-порта-и-транспорта"></a>
# Shipyard and Ferry Upgrades

[← All upgrades](README.md)

The Shipyard restores ships, while a separate upgrade increases Ferry capacity.

<a id="por--порт-лечение"></a>
<a id="порт-лечение-por"></a>
<a id="лечение-в-порту"></a>
## Shipyard healing
