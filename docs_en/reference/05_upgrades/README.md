...
Upgrades are grouped by **location** of research: academy / blacksmith / mill / stable / barracks / mine / tower / wall / ...

**Structure `sid`:**

- `<nat><place>.<unit>.<itype>.<level>` - upgrade for a specific unit in
  forge, stable or barracks (for example, `auspolbla.pikeman.1.3` =
  Austria → forge → pikeman → damage → level 3).
- `<nat><place>.<level>` - one per nation: in the academy, mill or
  town hall (for example, `auaca.4` = Austria → academy → upgrade No. 4
  "field melioration")
- `<cluster><place>.<level>` - common for a cluster of nations (for example,
  `eurtow.1` for all eur nations).
...
| Column | Meaning |
|---|---|
| **Upgrade** | Localized name + `sid`. |
| **Nations** | List of nations; `all` - if the upgrade is applicable to at least 18 nations. If one of the nations has its own value via `_country_ModifyUpgrade`, it is in a separate line. |
| **itype** | Effect type in human terms (decoding `gc_upg_type_*`): `+damage`, `+damage %`, `+protection`, `+food eff %`, `price %`, `build time %`, `enable unit`, `+shield`, etc. |
| **val** | Effect value. The semantics depends on `itype`: for percentage = just a number (50 means +50%, **−7500000 in `aca.10` = −75% buildtime — a special scale in the script, divisor × 10⁵**); for `+damage` / `+shield` = units. |
| **F / W / S / G / I / C** | Research price: **Food / Wood / Stone / Gold / Iron / Coal**. |
| **Time** | `time` to game seconds. The building is occupied by research at this time. |

> **How to read the tables below.** Each section has one row = one
> upgrade for one nation. If the value is the same for all 21 nations,
> instead of a list there is `all` (one line). If the nation
...
- [Mine upgrades (eurgol/eurcoa/euriro)](#апгрейды-шахт-eurgoleurcoaeuriro)
- [aca - Academy (research)](#aca--академия-исследования)
- [mil - Mill (food efficiency)](#mil--мельница-эффективность-еды)
- [bla - Blacksmith (by units - damage and defense)](#bla--кузница-по-юнитам--урон-и-защита)
- [sta - Stable (by units - cavalry)](#sta--конюшня-по-юнитам--кавалерия)
- [bar - Barracks 17th century. (by units)](#bar--казарма-17-в-по-юнитам)
- [ba2 - Barracks 18th century. (by units)](#ba2--казарма-18-в-по-юнитам)
- [art — Artillery Depot (gun upgrades)](#art--артиллерийское-депо-апгрейды-пушек)
- [cen - Town Hall (era transition)](#cen--городской-центр-переход-эпохи)
- [tow - Tower (reload speed)](#tow--башня-скорость-перезарядки)
- [swa - Stone wall (building a gate)](#swa--каменная-стена-постройка-ворот)
- [wwa - Palisade (building gates)](#wwa--палисад-постройка-ворот)
...
affects** the final parameters of the unit and building in almost all
cases. Each upgrade accumulates its term into a separate
object field (`damagestatic`, `damagepercent`, `protection[kind]`,
`shield`, `resefficiency[*]`, ...), and the final value
recalculated from a constant base.

Full analysis of `itype` (12 cases), summary table and bug
`speedperc` - to [`../../recon/world/economy/upgrades_application.md`
§7.6](../../recon/world/economy/upgrades_application.md).
**Practical conclusion for building simulators:** upgrades are possible
aggregate as sets without tracking their sequence
applications. Thin places - `priceperc`, `lifeperc`, `fishingperc`
(cumulative `round()` can give ±1 of the order) and a bug
`speedperc` (but not reapplied in current data).
...
| **Design multi-barrelled cannon** `ukraca.19` | alg,sco,tur,ukr | — | — | — | — | — | — | — | — | — | — |
...
| **Design Montgolfier (reveals the whole map)** `turaca.25` | alg,tur | — | — | — | — | — | — | — | — | — | — |
...
| **Design new rib system and new hulls (battleship construction)** `ukraca.29` | ukr | — | — | — | — | — | — | — | — | — | — |
...
| **Design bayonet: barrel-inserted, bayonet with a tube (cold steel weapons +5)** `ukraca.35` | alg,tur,ukr | — | — | — | — | — | — | — | — | — | — |
...
| **Research new steel grades (18c musketeer/grenadier melee attack efficiency +25%)** `ukraca.36` | alg,tur,ukr | — | — | — | — | — | — | — | — | — | — |
...
| **Develop new woodworking methods (frigate building)** `ukraca.6` | ukr | — | — | — | — | — | — | — | — | — | — |
| **Build new shipyards for fishing boats (fishing boat cost -85%)** `ausaca.7` | all | price % | 0 | wood -85% | 0 | 7300 | 0 | 1220 | 0 | 0 | 15.62 |
| **Build new shipyards for fishing boats (fishing boat cost -85%)** `fraaca.7` | fra | price % | 0 | wood -85% | 0 | 7800 | 0 | 1110 | 0 | 0 | 15.62 |
...
| **Improve grain crops treatment (harvesting +140%)** `turmil.1` | alg,tur | +food eff % | 140 | — | 600 | 0 | 0 | 250 | 0 | 0 | 15.62 |
| **Improve grain crops storage (harvesting +180%)** `eurmil.2` | aus,bav,den,eng,fra,hun,net,pie,pol,por,pru,rus,sax,spa,swe,swi,ven | +food eff % | 180 | — | 25600 | 0 | 0 | 3350 | 2000 | 0 | 15.62 |
| **Improve grain crops storage (harvesting +180%)** `rusmil.2` | sco,ukr | +food eff % | 180 | — | 5600 | 0 | 0 | 1350 | 1900 | 0 | 15.62 |

<a id="bla--кузница-по-юнитам--урон-и-защита"></a>
## bla - Blacksmith (by units - damage and defense)
...
| **Forge bayonets and broadswords for infantry (18c musketeer/grenadier melee attack +5)** `ukrbla.4` | alg,tur,ukr | — | — | — | — | — | — | — | — | — | — |
...
| **Forge new cuirasses (armoured soldiers defence +2)** `ukrbla.6` | alg,ukr | — | — | — | — | — | — | — | — | — | — |
...
## sta - Stable (by units - cavalry)

| Upgrade | Nations | itype | val | % by resources | F | W | S | G | I | C | Time |
|---|---|---|---:|---|---:|---:|---:|---:|---:|---:|---:|
| **Stable cossackdon damage +1 (lvl 2)** `russta.cossackdon.1.1` | rus | damage | 1 | — | 2000 | 0 | 0 | 500 | 0 | 0 | 15.62 |
| **Stable cossackdon damage +1 (lvl 3)** `russta.cossackdon.1.2` | rus | damage | 1 | — | 5000 | 0 | 0 | 800 | 0 | 0 | 15.62 |
| **Stable cossackdon damage +2 (lvl 4)** `russta.cossackdon.1.3` | rus | damage | 2 | — | 10000 | 0 | 0 | 1200 | 0 | 0 | 15.62 |
| **Stable cossackdon damage +2 (lvl 5)** `russta.cossackdon.1.4` | rus | damage | 2 | — | 20000 | 0 | 0 | 1300 | 0 | 0 | 15.62 |
| **Stable cossackdon damage +3 (lvl 6)** `russta.cossackdon.1.5` | rus | damage | 3 | — | 30000 | 0 | 0 | 4000 | 0 | 0 | 15.62 |
| **Stable cossackdon damage +3 (lvl 7)** `russta.cossackdon.1.6` | rus | damage | 3 | — | 20000 | 0 | 0 | 5000 | 0 | 0 | 15.62 |
...
| **Stable cossackregister damage +1 (lvl 2)** `ukrsta.cossackregister.1.1` | ukr | damage | 1 | — | 1000 | 0 | 0 | 3000 | 0 | 0 | 15.62 |
| **Stable cossackregister damage +2 (lvl 3)** `ukrsta.cossackregister.1.2` | ukr | damage | 2 | — | 2000 | 0 | 0 | 2000 | 0 | 0 | 15.62 |
| **Stable cossackregister damage +2 (lvl 4)** `ukrsta.cossackregister.1.3` | ukr | damage | 2 | — | 7100 | 0 | 0 | 8000 | 0 | 0 | 15.62 |
| **Stable cossackregister damage +2 (lvl 5)** `ukrsta.cossackregister.1.4` | ukr | damage | 2 | — | 2250 | 0 | 0 | 2000 | 0 | 0 | 15.62 |
| **Stable cossackregister damage +2 (lvl 6)** `ukrsta.cossackregister.1.5` | ukr | damage | 2 | — | 3030 | 0 | 0 | 5000 | 0 | 0 | 15.62 |
| **Stable cossackregister damage +1 (lvl 7)** `ukrsta.cossackregister.1.6` | ukr | damage | 1 | — | 7000 | 0 | 0 | 18000 | 0 | 0 | 15.62 |
...
| **Stable cossacksich damage +1 (lvl 2)** `ukrsta.cossacksich.1.1` | ukr | damage | 1 | — | 1000 | 0 | 0 | 3000 | 0 | 0 | 15.62 |
| **Stable cossacksich damage +2 (lvl 3)** `ukrsta.cossacksich.1.2` | ukr | damage | 2 | — | 2000 | 0 | 0 | 2000 | 0 | 0 | 15.62 |
| **Stable cossacksich damage +2 (lvl 4)** `ukrsta.cossacksich.1.3` | ukr | damage | 2 | — | 7100 | 0 | 0 | 8000 | 0 | 0 | 15.62 |
| **Stable cossacksich damage +1 (lvl 5)** `ukrsta.cossacksich.1.4` | ukr | damage | 1 | — | 2250 | 0 | 0 | 2000 | 0 | 0 | 15.62 |
| **Stable cossacksich damage +2 (lvl 6)** `ukrsta.cossacksich.1.5` | ukr | damage | 2 | — | 3030 | 0 | 0 | 4000 | 0 | 0 | 15.62 |
| **Stable cossacksich damage +2 (lvl 7)** `ukrsta.cossacksich.1.6` | ukr | damage | 2 | — | 7000 | 0 | 0 | 18000 | 0 | 0 | 15.62 |
...
| **Stable croat damage +1 (lvl 2)** `aussta.croat.1.1` | aus | damage | 1 | — | 2000 | 0 | 0 | 500 | 0 | 0 | 15.62 |
| **Stable croat damage +2 (lvl 3)** `aussta.croat.1.2` | aus | damage | 2 | — | 5000 | 0 | 0 | 800 | 0 | 0 | 15.62 |
| **Stable croat damage +2 (lvl 4)** `aussta.croat.1.3` | aus | damage | 2 | — | 10000 | 0 | 0 | 1200 | 0 | 0 | 15.62 |
| **Stable croat damage +1 (lvl 5)** `aussta.croat.1.4` | aus | damage | 1 | — | 20000 | 0 | 0 | 1300 | 0 | 0 | 15.62 |
| **Stable croat damage +2 (lvl 6)** `aussta.croat.1.5` | aus | damage | 2 | — | 30000 | 0 | 0 | 3000 | 0 | 0 | 15.62 |
| **Stable croat damage +2 (lvl 7)** `aussta.croat.1.6` | aus | damage | 2 | — | 20000 | 0 | 0 | 5000 | 0 | 0 | 15.62 |
...
| **Stable hussarhun damage +1 (lvl 2)** `hunsta.hussarhun.1.1` | hun | damage | 1 | — | 2000 | 0 | 0 | 500 | 0 | 0 | 15.62 |
| **Stable hussarhun damage +2 (lvl 3)** `hunsta.hussarhun.1.2` | hun | damage | 2 | — | 5000 | 0 | 0 | 800 | 0 | 0 | 15.62 |
| **Stable hussarhun damage +2 (lvl 4)** `hunsta.hussarhun.1.3` | hun | damage | 2 | — | 10000 | 0 | 0 | 1200 | 0 | 0 | 15.62 |
| **Stable hussarhun damage +3 (lvl 5)** `hunsta.hussarhun.1.4` | hun | damage | 3 | — | 20000 | 0 | 0 | 1300 | 0 | 0 | 15.62 |
| **Stable hussarhun damage +4 (lvl 6)** `hunsta.hussarhun.1.5` | hun | damage | 4 | — | 30000 | 0 | 0 | 3000 | 0 | 0 | 15.62 |
| **Stable hussarhun damage +5 (lvl 7)** `hunsta.hussarhun.1.6` | hun | damage | 5 | — | 20000 | 0 | 0 | 5000 | 0 | 0 | 15.62 |
...
| **Stable lancersco damage +1 (lvl 2)** `scosta.lancersco.1.1` | sco | damage | 1 | — | 1000 | 0 | 0 | 3000 | 0 | 0 | 15.62 |
| **Stable lancersco damage +1 (lvl 3)** `scosta.lancersco.1.2` | sco | damage | 1 | — | 2000 | 0 | 0 | 2000 | 0 | 0 | 15.62 |
| **Stable lancersco damage +2 (lvl 4)** `scosta.lancersco.1.3` | sco | damage | 2 | — | 7100 | 0 | 0 | 8000 | 0 | 0 | 15.62 |
| **Stable lancersco damage +1 (lvl 5)** `scosta.lancersco.1.4` | sco | damage | 1 | — | 2250 | 0 | 0 | 2000 | 0 | 0 | 15.62 |
| **Stable lancersco damage +2 (lvl 6)** `scosta.lancersco.1.5` | sco | damage | 2 | — | 3030 | 0 | 0 | 5000 | 0 | 0 | 15.62 |
| **Stable lancersco damage +3 (lvl 7)** `scosta.lancersco.1.6` | sco | damage | 3 | — | 7000 | 0 | 0 | 18000 | 0 | 0 | 15.62 |
...
| **Stable mameluke damage +1 (lvl 2)** `algsta.mameluke.1.1` | alg | damage | 1 | — | 1000 | 0 | 0 | 500 | 0 | 0 | 15.62 |
| **Stable mameluke damage +1 (lvl 3)** `algsta.mameluke.1.2` | alg | damage | 1 | — | 2000 | 0 | 0 | 2000 | 0 | 0 | 15.62 |
| **Stable mameluke damage +1 (lvl 4)** `algsta.mameluke.1.3` | alg | damage | 1 | — | 7100 | 0 | 0 | 3500 | 0 | 0 | 15.62 |
| **Stable mameluke damage +1 (lvl 5)** `algsta.mameluke.1.4` | alg | damage | 1 | — | 2250 | 0 | 0 | 5000 | 0 | 0 | 15.62 |
| **Stable mameluke damage +1 (lvl 6)** `algsta.mameluke.1.5` | alg | damage | 1 | — | 3030 | 0 | 0 | 6500 | 0 | 0 | 15.62 |
| **Stable mameluke damage +2 (lvl 7)** `algsta.mameluke.1.6` | alg | damage | 2 | — | 7000 | 0 | 0 | 8000 | 0 | 0 | 15.62 |
...
| **Stable raidersco damage +1 (lvl 2)** `scosta.raidersco.1.1` | sco | damage | 1 | — | 2000 | 0 | 0 | 500 | 0 | 0 | 15.62 |
| **Stable raidersco damage +2 (lvl 3)** `scosta.raidersco.1.2` | sco | damage | 2 | — | 5000 | 0 | 0 | 800 | 0 | 0 | 15.62 |
| **Stable raidersco damage +2 (lvl 4)** `scosta.raidersco.1.3` | sco | damage | 2 | — | 10000 | 0 | 0 | 1200 | 0 | 0 | 15.62 |
| **Stable raidersco damage +3 (lvl 5)** `scosta.raidersco.1.4` | sco | damage | 3 | — | 2000 | 0 | 0 | 6000 | 0 | 0 | 15.62 |
| **Stable raidersco damage +3 (lvl 6)** `scosta.raidersco.1.5` | sco | damage | 3 | — | 8100 | 0 | 0 | 1000 | 0 | 0 | 15.62 |
| **Stable raidersco damage +1 (lvl 7)** `scosta.raidersco.1.6` | sco | damage | 1 | — | 20000 | 0 | 0 | 3000 | 0 | 0 | 15.62 |
...
| **Stable spakh damage +1 (lvl 2)** `tursta.spakh.1.1` | tur | damage | 1 | — | 1000 | 0 | 0 | 500 | 0 | 0 | 15.62 |
| **Stable spakh damage +1 (lvl 3)** `tursta.spakh.1.2` | tur | damage | 1 | — | 2000 | 0 | 0 | 2000 | 0 | 0 | 15.62 |
| **Stable spakh damage +2 (lvl 4)** `tursta.spakh.1.3` | tur | damage | 2 | — | 7100 | 0 | 0 | 3500 | 0 | 0 | 15.62 |
| **Stable spakh damage +1 (lvl 5)** `tursta.spakh.1.4` | tur | damage | 1 | — | 2250 | 0 | 0 | 5000 | 0 | 0 | 15.62 |
| **Stable spakh damage +1 (lvl 6)** `tursta.spakh.1.5` | tur | damage | 1 | — | 3030 | 0 | 0 | 6500 | 0 | 0 | 15.62 |
| **Stable spakh damage +1 (lvl 7)** `tursta.spakh.1.6` | tur | damage | 1 | — | 7000 | 0 | 0 | 8000 | 0 | 0 | 15.62 |
...
## ba2 — Barracks 18th century. (by units)
...
## art — Artillery Depot (gun upgrades)
...
| Upgrade | Nations | itype | val | % by resources | F | W | S | G | I | C | Time |
|---|---|---|---:|---|---:|---:|---:|---:|---:|---:|---:|
| **Progress to the 18th Century** `auscen.1` | alg,aus,bav,hun,pie,por,rus,sax,sco,spa,swi,tur,ukr | enable unit | 0 | — | 30000 | 0 | 0 | 5000 | 2000 | 2000 | 9.38 |
| **Progress to the 18th Century** `prucen.1` | den,pru | enable unit | 0 | — | 20000 | 0 | 0 | 6500 | 1100 | 1100 | 9.38 |
| **Progress to the 18th Century** `fracen.1` | fra | enable unit | 0 | — | 40000 | 0 | 0 | 3500 | 4000 | 4000 | 9.38 |
| **Progress to the 18th Century** `engcen.1` | eng | enable unit | 0 | — | 25000 | 0 | 0 | 5000 | 5500 | 5500 | 9.38 |
| **Progress to the 18th Century** `polcen.1` | pol | enable unit | 0 | — | 30000 | 0 | 0 | 4800 | 2200 | 2200 | 9.38 |
| **Progress to the 18th Century** `swecen.1` | swe | enable unit | 0 | — | 37000 | 0 | 0 | 5500 | 1500 | 1500 | 9.38 |
| **Progress to the 18th Century** `vencen.1` | ven | enable unit | 0 | — | 40000 | 0 | 0 | 3000 | 2500 | 2500 | 9.38 |
| **Progress to the 18th Century** `netcen.1` | net | enable unit | 0 | — | 33000 | 0 | 0 | 4800 | 1800 | 1800 | 9.38 |
...
## swa - Stone wall (building a gate)
...
## por — Shipyard (treatment)

| Upgrade | Nations | itype | val | % by resources | F | W | S | G | I | C | Time |
|---|---|---|---:|---|---:|---:|---:|---:|---:|---:|---:|
| **Train woodworkers (repair all ships)** `eurpor.1` | all | healing | 50 | — | 0 | 20000 | 0 | 1500 | 0 | 0 | 46.88 |
| **Train woodworkers (repair all ships)** `eurpor.1` | eng | healing | 50 | — | 0 | 12000 | 0 | 500 | 0 | 0 | 46.88 |
