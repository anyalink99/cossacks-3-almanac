...
These tables place similar units and buildings from different nations side by
...
|---|---|
| [17th-century pikemen](units/pikemen.md) | Every national variant |
| [18th-century pikemen](units/pikemen18.md) | Every national variant |
...
| Comparison | What it covers |
|---|---|
| [Town halls](buildings/town_halls.md) | Variants for every nation |
| [Barracks](buildings/barracks.md) | 17th- and 18th-century barracks |
| [Academies](buildings/academies.md) | Shared research |
| [Artillery depots](buildings/artillery_depots.md) | Artillery production and limits |
| [Blacksmiths](buildings/blacksmiths.md) | Weapon and armor upgrades |
| [Diplomatic centers](buildings/diplomatic_centers.md) | Mercenaries |
| [Houses](buildings/houses.md) | Population limit |
| [Stables](buildings/stables.md) | Cavalry production |
| [Cathedrals, churches, and mosques](buildings/temples.md) | Priest production |
| [Mills](buildings/mills.md) | Architectural variants |
| [Markets](buildings/markets.md) | Architectural variants |
| [Storehouses](buildings/storehouses.md) | Architectural variants |
| [Shipyards](buildings/ports.md) | Architectural variants |
...
|---|---|
| [Projectiles](weapons/projectiles.md) | Arrows, cannonballs, and grenades: damage type, spread, speed, and the units that use them. Internal codes are shown only as secondary reference. |
