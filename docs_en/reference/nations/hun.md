...
- **Base peasant:** **Peasant** (`peapol`).
- The Mill, Storehouse, Market, and Tower use the same shared architectural set.

<a id="уникальные-юниты-5"></a>
## Unique units (5)

| Unit | Role | Health | Damage | Reload, game s | Range, cells |
|---|---|---:|---:|---:|---:|
| **Hajduk** `gauduk` | Ranged Infantry | 60 | 9 | 3.12 | 14.06 |
| **Grenadier** `grenadierhun` | Grenadier | 125 | 16 | 5.31 | 16.88 |
| **Hussar** `hussarhun` | Light Cavalry | 250 | 10 | 0.0 | 1.22 |
| **Light cavalry** `lightcavalry` | Mounted Ranged Unit | 175 | 14 | 5.31 | 18.75 |
| **Szekely** `pandurhun` | Ranged Infantry | 75 | 19 | 5.0 | 18.75 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Academy** `hunaca` | 63000 | 625.0 | 300 | 0 | 1250 | 1100 | 0 | 0 | 0 | 0 | — |
| **Artillery Depot** `hunart` | 40000 | 245.94 | 200 | 0 | 100 | 1000 | 0 | 0 | 1400 | 0 | Cannon, Frame gun, Howitzer, Bombard, Multi-barrelled Cannon |
| **Barracks, 18th century** `hunba2` | 55000 | 5625.0 | 200 | 0 | 1700 | 2950 | 4000 | 0 | 0 | 250 | Bow Clansman, Bagpiper, Chasseur, Drummer, 18th century, Grenadier (+19) |
| **Barracks, 17th century** `hunbar` | 40000 | 93.75 | 500 | 0 | 100 | 100 | 500 | 0 | 0 | 150 | Archer, Turkish archer, Drummer, 17th century, Drummer, 17th century, Drummer, 17th century (+24) |
| **Blacksmith** `hunbla` | 5500 | 93.75 | 400 | 0 | 100 | 30 | 0 | 640 | 0 | 0 | — |
| **Town Hall** `huncen` | 4000 | 156.25 | 300 | 0 | 700 | 700 | 0 | 0 | 0 | 100 | Peasant, Peasant, Peasant, Serf, Peasant (+3) |
| **Diplomatic Center** `hundip` | 4500 | 312.5 | 100 | 0 | 4900 | 1700 | 0 | 0 | 0 | 0 | Archer (mercenary), Turkish archer (mercenary), Sich Cossack (mercenary), Dragoon, 18th century (mercenary), Grenadier (mercenary) (+3) |
| **Housing** `hunhou` | 4000 | 31.25 | 104 | 0 | 100 | 100 | 0 | 0 | 0 | 25 | — |
| **Stable** `hunsta` | 20000 | 625.0 | 200 | 0 | 2500 | 100 | 600 | 0 | 0 | 0 | Don Cossack, Register Cossack, Sich Cossack, Croat, Cuirassier (+26) |
| **Cathedral** `huntem` | 4200 | 156.25 | 300 | 0 | 1000 | 1200 | 0 | 500 | 0 | 0 | Mullah, Padre, Pope, Priest |
...
| **Gate** `eursga` | 32000 | 90.0 | 0 | 0 | 0 | 50 | 0 | 0 | 0 | Contains 250 Stone |
| **Storehouse** `eursto` | 10000 | 31.25 | 150 | 0 | 50 | 20 | 0 | 0 | 0 | — |
| **Wall** `eurswa` | 50000 | 90.0 | 0 | 0 | 0 | 50 | 0 | 0 | 0 | Contains 250 Stone |
| **Tower** `eurtow` | 20000 | 1230.31 | 120 | 0 | 100 | 100 | 150 | 0 | 0 | Damage 1,000; upkeep 0.8 Gold/game s |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Peasant** `peapol` | 50 | 12.5 | 100 | 0 | 0 | 20 | 1.22 | 0.0 | semi-unique (2n) |
...
| Unit | Health | Training time, game s | Food | Gold | Iron | Damage | Range, cells | Reload, s | Availability |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Hajduk** `gauduk` | 60 | 4.5 | 35 | 4 | 4 | 9 | 14.06 | 3.12 | unique |
...
| **Grenadier** `grenadierhun` | 125 | 6.5 | 90 | 80 | 40 | 16 | 16.88 | 5.31 | unique |
...
| Unit | Health | Training time, game s | Food | Gold | Iron | Damage | Range, cells | Reload, s | Availability |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Szekely** `pandurhun` | 75 | 6.5 | 30 | 25 | 10 | 19 | 18.75 | 5.0 | unique |
...
| Unit | Health | Training time, game s | Food | Gold | Iron | Damage | Range, cells | Reload, s | Availability |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Hussar** `hussarhun` | 250 | 21.0 | 100 | 30 | 2 | 10 | 1.22 | 0.0 | unique |
| **Light cavalry** `lightcavalry` | 175 | 21.0 | 90 | 50 | 6 | 14 | 18.75 | 5.31 | unique |
