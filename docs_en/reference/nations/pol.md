...
|---|---|---:|---:|---:|---:|
| **Pospolite ruszenie** `dragoonpol` | Mounted Ranged Unit | 185 | 13 | 5.0 | 15.94 |
| **Musketeer, 17th century** `musketeerpol` | Ranged Infantry | 70 | 9 | 3.12 | 13.13 |
| **Pikeman, 17th century** `pikemanpol` | Light Infantry | 90 | 8 | 0.0 | 2.06 |
| **Light Reiter** `reiterpol` | Heavy Cavalry | 190 | 9 | 0.0 | 1.22 |
| **Winged Hussar** `wingedhussar` | Light Cavalry | 225 | 14 | 0.0 | 1.88 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Academy** `polaca` | 63000 | 625.0 | 300 | 0 | **950** | **800** | 0 | 0 | 0 | 0 | — |
| **Artillery Depot** `polart` | 40000 | 245.94 | 200 | 0 | 100 | 1000 | 0 | 0 | 1400 | 0 | Cannon, Frame gun, Howitzer, Bombard, Multi-barrelled Cannon |
| **Barracks, 18th century** `polba2` | 55000 | 5625.0 | 200 | 0 | 1700 | 2950 | 4000 | 0 | 0 | 250 | Bow Clansman, Bagpiper, Chasseur, Drummer, 18th century, Grenadier (+19) |
| **Barracks, 17th century** `polbar` | 40000 | 93.75 | 500 | 0 | 100 | 100 | 500 | 0 | 0 | 150 | Archer, Turkish archer, Drummer, 17th century, Drummer, 17th century, Drummer, 17th century (+24) |
| **Blacksmith** `polbla` | 5500 | 93.75 | 400 | 0 | 100 | 30 | 0 | 640 | 0 | 0 | — |
| **Town Hall** `polcen` | **4300** | 156.25 | 300 | 0 | 700 | 700 | 0 | 0 | 0 | 100 | Peasant, Peasant, Peasant, Serf, Peasant (+3) |
| **Diplomatic Center** `poldip` | 4500 | 312.5 | 100 | 0 | 4900 | 1700 | 0 | 0 | 0 | 0 | Archer (mercenary), Turkish archer (mercenary), Sich Cossack (mercenary), Dragoon, 18th century (mercenary), Grenadier (mercenary) (+3) |
| **Housing** `polhou` | **4100** | 31.25 | 104 | 0 | 100 | 100 | 0 | 0 | 0 | 25 | — |
| **Stable** `polsta` | 20000 | 625.0 | 200 | 0 | 2500 | 100 | 600 | 0 | 0 | 0 | Don Cossack, Register Cossack, Sich Cossack, Croat, Cuirassier (+25) |
| **Cathedral** `poltem` | 4200 | 156.25 | 300 | 0 | 1000 | 1200 | 0 | 500 | 0 | 0 | Mullah, Padre, Pope, Priest |
...
| Unit | Health | Training time, game s | Food | Gold | Iron | Damage | Range, cells | Reload, s | Availability |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Pikeman, 17th century** `pikemanpol` | 90 | 3.0 | 25 | 1 | 0 | 8 | 2.06 | 0.0 | unique |
...
| Unit | Health | Training time, game s | Food | Gold | Iron | Damage | Range, cells | Reload, s | Availability |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Musketeer, 17th century** `musketeerpol` | 70 | 4.5 | 40 | 3 | 3 | 9 | 13.13 | 3.12 | unique |
