...
<a id="уникальные-юниты-4"></a>
## Unique units (4)

| Unit | Role | Health | Damage | Reload, game s | Range, cells |
|---|---|---:|---:|---:|---:|
| **Croat** `croat` | Light Cavalry | 260 | 9 | 0.0 | 1.22 |
| **Musketeer, 17th century** `musketeeraus` | Ranged Infantry | 55 | 12 | 5.0 | 15.0 |
| **Pandur** `pandur` | Ranged Infantry | 85 | 17 | 4.69 | 16.88 |
| **Roundshier** `roundshier` | Light Infantry | 100 | 6 | 0.0 | 1.13 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Academy** `ausaca` | **65000** | 625.0 | 300 | 0 | 1250 | 1100 | 0 | 0 | 0 | 0 | — |
| **Artillery Depot** `ausart` | 40000 | 245.94 | 200 | 0 | 100 | 1000 | 0 | 0 | 1400 | 0 | Cannon, Frame gun, Howitzer, Bombard, Multi-barrelled Cannon |
| **Barracks, 18th century** `ausba2` | 55000 | 5625.0 | 200 | 0 | 1700 | 2950 | 4000 | 0 | 0 | 250 | Bow Clansman, Bagpiper, Chasseur, Drummer, 18th century, Grenadier (+19) |
| **Barracks, 17th century** `ausbar` | 40000 | 93.75 | 500 | 0 | 100 | 100 | 500 | 0 | 0 | 150 | Archer, Turkish archer, Drummer, 17th century, Drummer, 17th century, Drummer, 17th century (+24) |
| **Blacksmith** `ausbla` | 5500 | 93.75 | 400 | 0 | 100 | 30 | 0 | 640 | 0 | 0 | — |
| **Town Hall** `auscen` | 4000 | **46.88** | 300 | 0 | 700 | 700 | 0 | 0 | 0 | 100 | Peasant, Peasant, Peasant, Serf, Peasant (+3) |
| **Diplomatic Center** `ausdip` | 4500 | 312.5 | 100 | 0 | 4900 | 1700 | 0 | 0 | 0 | 0 | Archer (mercenary), Turkish archer (mercenary), Sich Cossack (mercenary), Dragoon, 18th century (mercenary), Grenadier (mercenary) (+3) |
| **Housing** `aushou` | 4000 | 31.25 | 104 | 0 | 100 | 100 | 0 | 0 | 0 | 25 | — |
| **Stable** `aussta` | 20000 | 625.0 | 200 | 0 | 2500 | 100 | 600 | 0 | 0 | 0 | Don Cossack, Register Cossack, Sich Cossack, Croat, Cuirassier (+25) |
| **Cathedral** `austem` | 4200 | 156.25 | 300 | 0 | 1000 | 1200 | 0 | 500 | 0 | 0 | Mullah, Padre, Pope, Priest |
...
| **Roundshier** `roundshier` | 100 | 4.0 | 20 | 3 | 25 | 6 | 1.13 | 0.0 | unique |
...
| Unit | Health | Training time, game s | Food | Gold | Iron | Damage | Range, cells | Reload, s | Availability |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Musketeer, 17th century** `musketeeraus` | 55 | 6.5 | 35 | 9 | 15 | 12 | 15.0 | 5.0 | unique |
...
| Unit | Health | Training time, game s | Food | Gold | Iron | Damage | Range, cells | Reload, s | Availability |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Pandur** `pandur` | 85 | 5.5 | 40 | 15 | 10 | 17 | 16.88 | 4.69 | unique |
...
| Unit | Health | Training time, game s | Food | Gold | Iron | Damage | Range, cells | Reload, s | Availability |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Croat** `croat` | 260 | 15.75 | 80 | 6 | 2 | 9 | 1.22 | 0.0 | unique |
