...
(See [ticks and subticks](../engine/ticks_and_subticks.md)).
...
`Nothing`-tick (see [ticks and subticks](../engine/ticks_and_subticks.md)).
...
[economy guide](../../docs_en/reference/01_economy/README.md))
...
`1 / 0.1831 ≈ 5.46` checks to defect. At roughly 0.625 game seconds per
check, that is about `0.625 / 0.1831 ≈ 3.4` game seconds. **An army of
50 mercenaries defects almost completely within 5–10 game seconds.**
On Easy and Normal, rebellion is nearly decorative.
...
|---|---|---|
| `farmused = 0` | The population limit is exhausted; results in **defeat** (see [Victory, Defeat, and the End of a Match](../../docs_en/recon/systems/victory_conditions.md)). |
