...
PATCHES = [
    ...
    },
    {
        ...
        "replacement": [
            ...
            "                              var bVictimShooter : Boolean = (trgUsage = gc_obj_usage_shooter) or (trgUsage = gc_obj_usage_horseshooter);",
            "                              if (bVictimShooter) and (bFatigueInf or bFatigueHorse) then begin",
