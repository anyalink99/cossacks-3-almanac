...
выстрела по **цели-стрелку** (`shooter` или `horseshooter`), который наносит
**250 урона** и уничтожает самого стрелка — `hp := 1` в момент выстрела,
retarget gate убивает его в ближайшем retarget window. По рукопашникам и
лучникам суицидальный выстрел не срабатывает. Обходит все прочие модификаторы урона.
