...
| `bmercenary` | Юнит-наёмник (`<unit>dip` суффикс). Расходует золото вместо еды; при пустом запасе золота и дефиците дохода может перейти к служебному игроку, враждебному всем участникам (см. бунт в разделе [«Экономика»](01_economy/README.md)). |
