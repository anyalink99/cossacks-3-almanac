...
# → output/simulations/sim_<your_build>.csv
# → output/simulations/sim_<your_build>.md
```
...
- **Эмпирическая скорость крестьянина** в тайлах/игр-сек — нужна для замены статического `walk_overhead = 0.30` физическим расчётом. См. [`../../recon/peasant_extraction.md`](../../recon/peasant_extraction.md) §9.
