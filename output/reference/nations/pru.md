...
|---|---|---:|---:|---:|---:|
| **Гренадер** / Grenadier `grenadierpru` | Grenadier | 125 | 18 | 0.0 | 1.5 |
| **Гусар** / Hussar `hussarpru` | Light Cavalry | 240 | 9 | 0.0 | 1.22 |
| **Мушкетер 18в.** / Musketeer, 18th century `musketeer18pru` | Shooter | 100 | 10 | 0.0 | 1.59 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Академия** / Academy `pruaca` | 63000 | 625.0 | 300 | 0 | **1200** | **1150** | 0 | 0 | 0 | 0 | — |
| **Артиллерийское депо** / Artillery Depot `pruart` | 40000 | 245.94 | 200 | 0 | 100 | 1000 | 0 | 0 | 1400 | 0 | cannon, framegun, howitzer, mortar, multicannon |
| **Казарма 18в.** / Barracks, 18th century `pruba2` | 55000 | 5625.0 | 200 | 0 | 1700 | 2950 | 4000 | 0 | 0 | 250 | archersco, bagpiper, chasseur, drummer18, grenadier (+19) |
| **Казарма 17в.** / Barracks, 17th century `prubar` | 40000 | 93.75 | 500 | 0 | 100 | 100 | 500 | 0 | 0 | 150 | archer, archertur, drummer, drummerrus, drummertur (+24) |
| **Кузница** / Blacksmith `prubla` | 5500 | 93.75 | 400 | 0 | 100 | 30 | 0 | 640 | 0 | 0 | — |
| **Городской центр** / Town Hall `prucen` | **4200** | 156.25 | 300 | 0 | 700 | 700 | 0 | 0 | 0 | 100 | peaaus, peaeng, peapol, pearus, peasco (+3) |
| **Дипломатический центр** / Diplomatic Center `prudip` | 4500 | 312.5 | 100 | 0 | 4900 | 1700 | 0 | 0 | 0 | 0 | archerdip, archerturdip, cossacksichdip, dragoon18dip, grenadierdip (+3) |
| **Дом** / Housing `pruhou` | **4500** | 31.25 | 104 | 0 | 100 | 100 | 0 | 0 | 0 | 25 | — |
| **Конюшня** / Stable `prusta` | 20000 | 625.0 | 200 | 0 | 2500 | 100 | 600 | 0 | 0 | 0 | cossackdon, cossackregister, cossacksich, croat, cuirassier (+25) |
| **Собор** / Cathedral `prutem` | 4200 | 156.25 | 300 | 0 | 1000 | 1200 | 0 | 500 | 0 | 0 | mullah, padre, pope, priest |
...
| Юнит | HP | Time | F | G | I | dmg | rng (t) | reload | uniqueness |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Мушкетер 18в.** / Musketeer, 18th century `musketeer18pru` | 100 | 6.0 | 70 | 80 | 40 | 10 | 1.59 | 0.0 | unique |
...
| **Гренадер** / Grenadier `grenadierpru` | 125 | 7.0 | 90 | 100 | 45 | 18 | 1.5 | 0.0 | unique |
...
| Юнит | HP | Time | F | G | I | dmg | rng (t) | reload | uniqueness |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Гусар** / Hussar `hussarpru` | 240 | 11.25 | 80 | 15 | 2 | 9 | 1.22 | 0.0 | unique |
