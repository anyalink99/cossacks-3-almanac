...
|---|---|---:|---:|---:|---:|
| **Мушкетер 17в.** / Musketeer, 17th century `musketeerspa` | Shooter | 85 | 15 | 5.94 | 15.94 |
| **Коселет** / Coselete `pikemanspa` | Light Infantry | 100 | 10 | 0.0 | 1.88 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Академия** / Academy `spaaca` | 63000 | 625.0 | 300 | 0 | **1350** | **1000** | 0 | 0 | 0 | 0 | — |
| **Артиллерийское депо** / Artillery Depot `spaart` | 40000 | 245.94 | 200 | 0 | 100 | 1000 | 0 | 0 | 1400 | 0 | cannon, framegun, howitzer, mortar, multicannon |
| **Казарма 18в.** / Barracks, 18th century `spaba2` | 55000 | 5625.0 | 200 | 0 | 1700 | 2950 | 4000 | 0 | 0 | 250 | archersco, bagpiper, chasseur, drummer18, grenadier (+19) |
| **Казарма 17в.** / Barracks, 17th century `spabar` | 40000 | 93.75 | 500 | 0 | 100 | 100 | 500 | 0 | 0 | 150 | archer, archertur, drummer, drummerrus, drummertur (+24) |
| **Кузница** / Blacksmith `spabla` | 5500 | 93.75 | 400 | 0 | 100 | 30 | 0 | 640 | 0 | 0 | — |
| **Городской центр** / Town Hall `spacen` | **4250** | 156.25 | 300 | 0 | 700 | 700 | 0 | 0 | 0 | 100 | peaaus, peaeng, peapol, pearus, peasco (+3) |
| **Дипломатический центр** / Diplomatic Center `spadip` | 4500 | 312.5 | 100 | 0 | 4900 | 1700 | 0 | 0 | 0 | 0 | archerdip, archerturdip, cossacksichdip, dragoon18dip, grenadierdip (+3) |
| **Дом** / Housing `spahou` | **4200** | 31.25 | 104 | 0 | 100 | 100 | 0 | 0 | 0 | 25 | — |
| **Конюшня** / Stable `spasta` | 20000 | 625.0 | 200 | 0 | 2500 | 100 | 600 | 0 | 0 | 0 | cossackdon, cossackregister, cossacksich, croat, cuirassier (+25) |
| **Собор** / Cathedral `spatem` | 4200 | 156.25 | 300 | 0 | 1000 | 1200 | 0 | 500 | 0 | 0 | mullah, padre, pope, priest |
...
| **Рынок** / Market `spamar` | 4000 | 156.25 | 2000 | 0 | 450 | 0 | 0 | 0 | 0 | — |
| **Склад** / Storehouse `spasto` | 10000 | 31.25 | 150 | 0 | 20 | 20 | 0 | 0 | 0 | — |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Крестьянин** / Peasant `peaspa` | 50 | 12.5 | 100 | 0 | 0 | 20 | 1.22 | 0.0 | shared (4n) |

### Pikemen 17c

| Юнит | HP | Time | F | G | I | dmg | rng (t) | reload | uniqueness |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Пикинер 17в.** / Pikeman, 17th century `pikeman` | 100 | 5.5 | 35 | 7 | 30 | 10 | 1.88 | 0.0 | shared (13n) |
| **Коселет** / Coselete `pikemanspa` | 100 | 5.5 | 35 | 7 | 30 | 10 | 1.88 | 0.0 | unique |
...
| Юнит | HP | Time | F | G | I | dmg | rng (t) | reload | uniqueness |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| **Мушкетер 17в.** / Musketeer, 17th century `musketeerspa` | 85 | 7.5 | 40 | 12 | 20 | 15 | 15.94 | 5.94 | unique |
