...
**Производный** файл (расчётный, не извлечение). Считается из `output/data.json` скриптом [`compute/compute_combat_stats.py`](../../../compute/compute_combat_stats.py).
...
| `archerturdip` | sco | Archer | 150 | 32 | 150d / 4.38s / 18.75t [firearrow] | 34.25 | 47.95 | — |
| `archerdip` | tur | Archer | 65 | 32 | 150d / 4.38s / 16.88t [firearrow] | 34.25 | 47.95 | — |
| `archertur` | tur | Archer | 65 | 32 | 150d / 4.38s / 16.88t [firearrow] | 34.25 | 47.95 | — |
| `archerturdip` | tur | Archer | 65 | 32 | 150d / 4.38s / 16.88t [firearrow] | 34.25 | 47.95 | — |
| `archer` | alg | Archer | 40 | 32 | 150d / 3.91s / 11.25t [firearrow] | 38.36 | 53.7 | — |
| `archerdip` | alg, aus, bav, den, eng … (+14 more) | Archer | 40 | 32 | 150d / 3.91s / 11.25t [firearrow] | 38.36 | 53.7 | — |
| `archerturdip` | alg, aus, bav, den, eng … (+14 more) | Archer | 40 | 32 | 150d / 3.91s / 11.25t [firearrow] | 38.36 | 53.7 | — |
...
| `grenadierdip` | all | Grenadier | 120 | 32 | 110d / 2.34s / 9.38t [mortarball] | 47.01 | 65.81 | — |
...
| `cossacksichdip` | all | Light Cavalry | 250 | 96 | 13d / 0 (melee) / 1.22t [sword] | — | — | — |
...
| `roundshierdip` | sco | Light Infantry | 180 | 32 | 10d / 0 (melee) / 1.13t [sword] | — | — | pike=1, sword=2, bullet=2, cannister=110, arrow=6, cannonball=10 |
...
| `roundshierdip` | alg, aus, bav, den, eng … (+15 more) | Light Infantry | 100 | 32 | 6d / 0 (melee) / 1.13t [sword] | — | — | pike=3, sword=3, bullet=7, cannister=225, arrow=16, cannonball=80 |
...
| `lightinfantrydip` | all | Light Infantry | 55 | 32 | 5d / 0 (melee) / 0.94t [sword] | — | — | — |
...
| `dragoon18dip` | all | Mounted Shooter | 225 | 56 | 19d / 5.31s / 16.88t [bullet] | 3.58 | 5.01 | — |
| `lightcavalrydip` | all | Mounted Shooter | 225 | 56 | 19d / 5.31s / 16.88t [bullet] | 3.58 | 5.01 | — |
...
| 5 | `grenadier` | aus, eng, fra, net, pie … (+8 more) | Grenadier | 120 | mortarball | 110 | 2.34 | 9.38 | 47.01 | 65.81 |
| 6 | `grenadierdip` | all | Grenadier | 120 | mortarball | 110 | 2.34 | 9.38 | 47.01 | 65.81 |
| 7 | `grenadierpru` | pru | Grenadier | 125 | mortarball | 110 | 2.34 | 9.38 | 47.01 | 65.81 |
| 8 | `grenadierden` | den | Grenadier | 125 | mortarball | 110 | 2.34 | 9.38 | 47.01 | 65.81 |
| 9 | `grenadiersax` | sax | Grenadier | 100 | mortarball | 110 | 2.34 | 9.38 | 47.01 | 65.81 |
| 10 | `grenadierbav` | bav | Grenadier | 125 | mortarball | 110 | 2.34 | 9.38 | 47.01 | 65.81 |
| 11 | `grenadierhun` | hun | Grenadier | 125 | mortarball | 110 | 2.81 | 11.25 | 39.15 | 54.81 |
| 12 | `archerdip` | alg, aus, bav, den, eng … (+14 more) | Archer | 40 | firearrow | 150 | 3.91 | 11.25 | 38.36 | 53.7 |
| 13 | `archerturdip` | alg, aus, bav, den, eng … (+14 more) | Archer | 40 | firearrow | 150 | 3.91 | 11.25 | 38.36 | 53.7 |
| 14 | `archer` | alg | Archer | 40 | firearrow | 150 | 3.91 | 11.25 | 38.36 | 53.7 |
| 15 | `archerdip` | tur | Archer | 65 | firearrow | 150 | 4.38 | 16.88 | 34.25 | 47.95 |
| 16 | `archertur` | tur | Archer | 65 | firearrow | 150 | 4.38 | 16.88 | 34.25 | 47.95 |
| 17 | `archerturdip` | tur | Archer | 65 | firearrow | 150 | 4.38 | 16.88 | 34.25 | 47.95 |
| 18 | `archerdip` | sco | Archer | 150 | firearrow | 150 | 4.38 | 18.75 | 34.25 | 47.95 |
| 19 | `archersco` | sco | Archer | 150 | firearrow | 150 | 4.38 | 18.75 | 34.25 | 47.95 |
| 20 | `archerturdip` | sco | Archer | 150 | firearrow | 150 | 4.38 | 18.75 | 34.25 | 47.95 |
| 21 | `tatar` | tur | Archer | 185 | firearrow | 140 | 4.69 | 20.63 | 29.85 | 41.79 |
| 22 | `mortar` | all | Super Mortar | 400 | mortarball | 200 | 7.81 | 48.75 | 25.61 | 35.85 |
| 23 | `kingmusketeer` | fra | Mounted Shooter | 280 | bullet | 43 | 6.88 | 13.13 | 6.25 | 8.75 |
| 24 | `musketeer18den` | den | Shooter | 100 | bullet | 29 | 5.94 | 16.88 | 4.88 | 6.83 |
| 25 | `musketeer18pru` | pru | Shooter | 100 | bullet | 22 | 4.69 | 17.81 | 4.69 | 6.57 |
| 26 | `musketeer18sax` | sax | Shooter | 90 | bullet | 19 | 4.38 | 16.88 | 4.34 | 6.08 |
| 27 | `dragoon18pie` | pie | Mounted Shooter | 200 | bullet | 19 | 5.0 | 16.88 | 3.8 | 5.32 |
| 28 | `pandurhun` | hun | Shooter | 75 | bullet | 19 | 5.0 | 18.75 | 3.8 | 5.32 |
| 29 | `musketeer18bav` | bav | Shooter | 100 | bullet | 22 | 5.94 | 17.81 | 3.7 | 5.18 |
| 30 | `pandur` | aus | Shooter | 85 | bullet | 17 | 4.69 | 16.88 | 3.62 | 5.07 |
| 31 | `dragoon18` | aus, bav, den, eng, pol … (+8 more) | Mounted Shooter | 225 | bullet | 19 | 5.31 | 16.88 | 3.58 | 5.01 |
| 32 | `dragoon18dip` | all | Mounted Shooter | 225 | bullet | 19 | 5.31 | 16.88 | 3.58 | 5.01 |
| 33 | `lightcavalrydip` | all | Mounted Shooter | 225 | bullet | 19 | 5.31 | 16.88 | 3.58 | 5.01 |
| 34 | `musketeer18` | aus, eng, fra, hun, net … (+8 more) | Shooter | 100 | bullet | 16 | 4.69 | 16.88 | 3.41 | 4.77 |
| 35 | `dragoon18net` | net | Mounted Shooter | 320 | bullet | 17 | 5.0 | 15.94 | 3.4 | 4.76 |
| 36 | `chasseur` | fra | Shooter | 75 | bullet | 20 | 5.94 | 19.69 | 3.37 | 4.72 |
| 37 | `highlander` | eng | Shooter | 130 | bullet | 16 | 5.0 | 15.94 | 3.2 | 4.48 |
| 38 | `serdiuk` | ukr | Shooter | 85 | bullet | 12 | 4.06 | 16.88 | 2.96 | 4.14 |
| 39 | `jagerswi` | swi | Shooter | 65 | bullet | 20 | 6.88 | 22.5 | 2.91 | 4.07 |
| 40 | `musketeerpol` | pol | Shooter | 70 | bullet | 9 | 3.12 | 13.13 | 2.88 | 4.03 |
| 41 | `gauduk` | hun | Shooter | 60 | bullet | 9 | 3.12 | 14.06 | 2.88 | 4.03 |
| 42 | `dragoon` | aus, bav, den, eng, fra … (+11 more) | Mounted Shooter | 220 | bullet | 15 | 5.62 | 15.0 | 2.67 | 3.74 |
| 43 | `musketeernet` | net | Shooter | 65 | bullet | 10 | 3.75 | 15.0 | 2.67 | 3.74 |
| 44 | `lightcavalry` | hun | Mounted Shooter | 175 | bullet | 14 | 5.31 | 18.75 | 2.64 | 3.7 |
| 45 | `dragoonpol` | pol | Mounted Shooter | 185 | bullet | 13 | 5.0 | 15.94 | 2.6 | 3.64 |
| 46 | `musketeer` | bav, den, eng, fra, pie … (+6 more) | Shooter | 70 | bullet | 12 | 4.69 | 15.0 | 2.56 | 3.58 |
| 47 | `strelet` | rus | Shooter | 85 | bullet | 12 | 4.69 | 13.13 | 2.56 | 3.58 |
| 48 | `jannisary` | tur | Shooter | 65 | bullet | 12 | 4.69 | 15.94 | 2.56 | 3.58 |
| 49 | `musketeersco` | sco | Shooter | 90 | bullet | 12 | 4.69 | 15.94 | 2.56 | 3.58 |
| 50 | `musketeerspa` | spa | Shooter | 85 | bullet | 15 | 5.94 | 15.94 | 2.53 | 3.54 |
| 51 | `musketeeraus` | aus | Shooter | 55 | bullet | 12 | 5.0 | 15.0 | 2.4 | 3.36 |
...
| `roundshierdip` | sco | Light Infantry | 180 | — | 20.0 | 22.5 | 22.5 | 180.0 | 45.0 | 180.0 |
...
| `roundshierdip` | alg, aus, bav, den, eng … (+15 more) | Light Infantry | 100 | — | 14.3 | 14.3 | 33.3 | 100.0 | 100.0 | 100.0 |
