# Отчёт симуляции: bav_basic_5min

- Нация: **bav**
- Скорость игры: **fast** (×1.4)
- Макс. время: **360 g-sec** = 257.1 real-sec
- Накладные расходы на ходьбу: 30% (на поверхности), 5% (в шахтах)

## Итоговое состояние

- Время: **360 g-sec / 257 real-sec**
- Ресурсы: FOOD=2227 / WOOD=2870 / STONE=620 / GOLD=1128 / IRON=1833 / COAL=0
- Ферма: 15/150
- Крестьян всего: 15 (без работы: 0)
- Здания: {'bavcen': 1, 'eursto': 1, 'euriro': 1, 'eurcoa': 1, 'eurgol': 1, 'bavhou': 2, 'bavbla': 1, 'eurmil': 1, 'bavbar': 0}
- Юниты: {'peaaus': 15}
- Завершено апгрейдов (0): []

## Таймлайн (снимки каждые 5 g-sec)

| t_g | t_real | F | W | S | G | I | C | ферма | крест. | здания |
|---:|---:|---:|---:|---:|---:|---:|---:|---|---:|---|
...
Сгенерировано скриптом `simulator/simulate_economy.py`. Билд-ордер: simulator\build_orders\bav_basic_5min.json