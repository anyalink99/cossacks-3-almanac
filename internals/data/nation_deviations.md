...
- **Базовый вариант** (7/21): **bav** Бавария, **hun** Венгрия, **pie** Пьемонт, **por** Португалия, **sax** Саксония … (+2)
  - HP **4000**, buildtime **156.25** игр. с, costpercent **300**
  - цена: 700 W · 700 S
  - score=1000, farm=100
  - produces: peaaus, peaeng, peapol, pearus, peasco, peaspa, peatur, peaukr

- **Отклонение 1** (2/21): **den** Дания, **eng** Англия
  - HP **4030**, buildtime **156.25** игр. с, costpercent **300**
  - цена: 700 W · 700 S
  - score=1000, farm=100
  - produces: peaaus, peaeng, peapol, pearus, peasco, peaspa, peatur, peaukr

- **Отклонение 2** (1/21): **aus** Австрия
  - HP **4000**, buildtime **46.88** игр. с, costpercent **300**
  - цена: 700 W · 700 S
  - score=1000, farm=100
  - produces: peaaus, peaeng, peapol, pearus, peasco, peaspa, peatur, peaukr

- **Отклонение 3** (1/21): **fra** Франция
  - HP **4500**, buildtime **156.25** игр. с, costpercent **300**
  - цена: 700 W · 700 S
  - score=1000, farm=100
  - produces: peaaus, peaeng, peapol, pearus, peasco, peaspa, peatur, peaukr

- **Отклонение 4** (1/21): **spa** Испания
  - HP **4250**, buildtime **156.25** игр. с, costpercent **300**
  - цена: 700 W · 700 S
  - score=1000, farm=100
  - produces: peaaus, peaeng, peapol, pearus, peasco, peaspa, peatur, peaukr

- **Отклонение 5** (1/21): **rus** Россия
  - HP **4050**, buildtime **156.25** игр. с, costpercent **300**
  - цена: 680 W · 700 S
  - score=1000, farm=75
  - produces: peaaus, peaeng, peapol, pearus, peasco, peaspa, peatur, peaukr

- **Отклонение 6** (1/21): **ukr** Украина
  - HP **5300**, buildtime **156.25** игр. с, costpercent **400**
  - цена: 700 W
  - score=1000, farm=200
  - produces: peaaus, peaeng, peapol, pearus, peasco, peaspa, peatur, peaukr

- **Отклонение 7** (1/21): **pol** Польша
  - HP **4300**, buildtime **156.25** игр. с, costpercent **300**
  - цена: 700 W · 700 S
  - score=1000, farm=100
  - produces: peaaus, peaeng, peapol, pearus, peasco, peaspa, peatur, peaukr

- **Отклонение 8** (1/21): **swe** Швеция
  - HP **5000**, buildtime **156.25** игр. с, costpercent **300**
  - цена: 700 W · 700 S
  - score=1000, farm=100
  - produces: peaaus, peaeng, peapol, pearus, peasco, peaspa, peatur, peaukr

- **Отклонение 9** (1/21): **pru** Пруссия
  - HP **4200**, buildtime **156.25** игр. с, costpercent **300**
  - цена: 700 W · 700 S
  - score=1000, farm=100
  - produces: peaaus, peaeng, peapol, pearus, peasco, peaspa, peatur, peaukr

- **Отклонение 10** (1/21): **ven** Венеция
  - HP **5100**, buildtime **156.25** игр. с, costpercent **300**
  - цена: 700 W · 700 S
  - score=1000, farm=100
  - produces: peaaus, peaeng, peapol, pearus, peasco, peaspa, peatur, peaukr
...
- **Отклонение 12** (1/21): **alg** Алжир
  - HP **5500**, buildtime **156.25** игр. с, costpercent **300**
  - цена: 450 W · 700 S
  - score=1000, farm=50
  - produces: peaaus, peaeng, peapol, pearus, peasco, peaspa, peatur, peaukr

- **Отклонение 13** (1/21): **net** Нидерланды
  - HP **4950**, buildtime **156.25** игр. с, costpercent **300**
  - цена: 700 W · 700 S
  - score=1000, farm=100
  - produces: peaaus, peaeng, peapol, pearus, peasco, peaspa, peatur, peaukr
...
- **Базовый вариант** (10/21): **aus** Австрия, **bav** Бавария, **den** Дания, **fra** Франция, **hun** Венгрия … (+5)
  - HP **4000**, buildtime **31.25** игр. с, costpercent **104**
  - цена: 100 W · 100 S
  - score=100, farm=25
  - produces: —

- **Отклонение 1** (3/21): **eng** Англия, **swe** Швеция, **ven** Венеция
  - HP **5000**, buildtime **31.25** игр. с, costpercent **104**
  - цена: 100 W · 100 S
  - score=100, farm=25
  - produces: —

- **Отклонение 2** (2/21): **net** Нидерланды, **pru** Пруссия
  - HP **4500**, buildtime **31.25** игр. с, costpercent **104**
  - цена: 100 W · 100 S
  - score=100, farm=25
  - produces: —

- **Отклонение 3** (1/21): **spa** Испания
  - HP **4200**, buildtime **31.25** игр. с, costpercent **104**
  - цена: 100 W · 100 S
  - score=100, farm=25
  - produces: —
...
- **Отклонение 5** (1/21): **ukr** Украина
  - HP **4150**, buildtime **31.25** игр. с, costpercent **105**
  - цена: 120 W
  - score=100, farm=25
  - produces: —

- **Отклонение 6** (1/21): **pol** Польша
  - HP **4100**, buildtime **31.25** игр. с, costpercent **104**
  - цена: 100 W · 100 S
  - score=100, farm=25
  - produces: —

- **Отклонение 7** (1/21): **tur** Турция
  - HP **4000**, buildtime **31.25** игр. с, costpercent **106**
  - цена: 100 W · 100 S
  - score=100, farm=25
  - produces: —

- **Отклонение 8** (1/21): **alg** Алжир
  - HP **4300**, buildtime **31.25** игр. с, costpercent **104**
  - цена: 100 W · 100 S
  - score=100, farm=25
  - produces: —
...
- **Базовый вариант** (16/21): **aus** Австрия, **bav** Бавария, **den** Дания, **eng** Англия, **fra** Франция … (+11)
  - HP **40000**, buildtime **93.75** игр. с, costpercent **500**
...
- **Отклонение 1** (2/21): **alg** Алжир, **tur** Турция
  - HP **35000**, buildtime **93.75** игр. с, costpercent **500**
  - цена: 400 W · 400 S
  - score=500, farm=50
  - produces: archer, archertur, drummer, drummerrus, drummertur, gauduk, jannisary, lightinfantry, musketeer, musketeeraus, musketeernet, musketeerpol, musketeersco, musketeerspa, officer, officerrus, officersco, officertur, pikeman, pikemanpol, pikemanpor, pikemanrus, pikemansco, pikemanspa, pikemanswi, pikemantur, roundshier, serdiuk, strelet

- **Отклонение 2** (1/21): **rus** Россия
  - HP **25000**, buildtime **78.12** игр. с, costpercent **300**
  - цена: 200 W · 20 S
  - score=500, farm=25
  - produces: archer, archertur, drummer, drummerrus, drummertur, gauduk, jannisary, lightinfantry, musketeer, musketeeraus, musketeernet, musketeerpol, musketeersco, musketeerspa, officer, officerrus, officersco, officertur, pikeman, pikemanpol, pikemanpor, pikemanrus, pikemansco, pikemanspa, pikemanswi, pikemantur, roundshier, serdiuk, strelet

- **Отклонение 3** (1/21): **ukr** Украина
  - HP **20000**, buildtime **93.75** игр. с, costpercent **300**
  - цена: 150 W · 150 S
  - score=500, farm=75
  - produces: archer, archertur, drummer, drummerrus, drummertur, gauduk, jannisary, lightinfantry, musketeer, musketeeraus, musketeernet, musketeerpol, musketeersco, musketeerspa, officer, officerrus, officersco, officertur, pikeman, pikemanpol, pikemanpor, pikemanrus, pikemansco, pikemanspa, pikemanswi, pikemantur, roundshier, serdiuk, strelet

- **Отклонение 4** (1/21): **sco** Шотландия
  - HP **30000**, buildtime **93.75** игр. с, costpercent **500**
  - цена: 100 W · 100 S · 500 G
  - score=500, farm=150
...
- **Базовый вариант** (17/21): **aus** Австрия, **bav** Бавария, **den** Дания, **eng** Англия, **fra** Франция … (+12)
  - HP **55000**, buildtime **5625.0** игр. с, costpercent **200**
...
- **Отклонение 1** (1/21): **sco** Шотландия
  - HP **40000**, buildtime **625.0** игр. с, costpercent **250**
...
- **Базовый вариант** (14/21): **aus** Австрия, **bav** Бавария, **den** Дания, **fra** Франция, **net** Нидерланды … (+9)
  - HP **20000**, buildtime **625.0** игр. с, costpercent **200**
...
- **Отклонение 1** (2/21): **eng** Англия, **sco** Шотландия
  - HP **25000**, buildtime **375.0** игр. с, costpercent **200**
  - цена: 2350 W · 800 G
  - score=500
  - produces: cossackdon, cossackregister, cossacksich, croat, cuirassier, dragoon, dragoon18, dragoon18fra, dragoon18net, dragoon18pie, dragoonpol, guardcavalrysax, hackapell, hetman, hussar, hussarhun, hussarpru, hussarswi, kingmusketeer, lancersco, mameluke, raidersco, reiter, reiterpol, reiterswe, sipahi, spakh, tatar, vityaz, wingedhussar
...
- **Отклонение 3** (1/21): **ukr** Украина
  - HP **10000**, buildtime **156.25** игр. с, costpercent **300**
  - цена: 3200 W · 850 S · 850 G
  - score=500
  - produces: cossackdon, cossackregister, cossacksich, croat, cuirassier, dragoon, dragoon18, dragoon18fra, dragoon18net, dragoon18pie, dragoonpol, guardcavalrysax, hackapell, hetman, hussar, hussarhun, hussarpru, hussarswi, kingmusketeer, lancersco, mameluke, raidersco, reiter, reiterpol, reiterswe, sipahi, spakh, tatar, vityaz, wingedhussar

- **Отклонение 4** (1/21): **tur** Турция
  - HP **55000**, buildtime **156.25** игр. с, costpercent **700**
  - цена: 1000 W · 2600 S
  - score=500
  - produces: cossackdon, cossackregister, cossacksich, croat, cuirassier, dragoon, dragoon18, dragoon18fra, dragoon18net, dragoon18pie, dragoonpol, guardcavalrysax, hackapell, hetman, hussar, hussarhun, hussarpru, hussarswi, kingmusketeer, lancersco, mameluke, raidersco, reiter, reiterpol, reiterswe, sipahi, spakh, tatar, vityaz, wingedhussar
...
- **Базовый вариант** (8/21): **bav** Бавария, **fra** Франция, **hun** Венгрия, **pie** Пьемонт, **por** Португалия … (+3)
  - HP **63000**, buildtime **625.0** игр. с, costpercent **300**
  - цена: 1250 W · 1100 S
  - score=500
  - produces: —
...
- **Отклонение 2** (2/21): **alg** Алжир, **tur** Турция
  - HP **65000**, buildtime **156.25** игр. с, costpercent **300**
  - цена: 1450 W · 1100 S
  - score=500
  - produces: —

- **Отклонение 3** (1/21): **aus** Австрия
  - HP **65000**, buildtime **625.0** игр. с, costpercent **300**
  - цена: 1250 W · 1100 S
  - score=500
  - produces: —
...
- **Отклонение 5** (1/21): **rus** Россия
  - HP **65000**, buildtime **843.75** игр. с, costpercent **300**
  - цена: 1250 W · 1300 S
  - score=500
  - produces: —

- **Отклонение 6** (1/21): **ukr** Украина
  - HP **65000**, buildtime **46.88** игр. с, costpercent **300**
  - цена: 1350 W · 1200 S
  - score=500
  - produces: —
...
- **Базовый вариант** (17/21): **aus** Австрия, **bav** Бавария, **den** Дания, **eng** Англия, **hun** Венгрия … (+12)
  - HP **5500**, buildtime **93.75** игр. с, costpercent **400**
  - цена: 100 W · 30 S · 640 I
  - score=500
  - produces: —

- **Отклонение 1** (2/21): **alg** Алжир, **tur** Турция
  - HP **6500**, buildtime **109.38** игр. с, costpercent **400**
  - цена: 100 W · 30 S · 640 I
  - score=500
  - produces: —

- **Отклонение 2** (1/21): **fra** Франция
  - HP **5500**, buildtime **93.75** игр. с, costpercent **600**
  - цена: 100 W · 30 S · 640 I
  - score=500
  - produces: —

- **Отклонение 3** (1/21): **ukr** Украина
  - HP **4500**, buildtime **62.5** игр. с, costpercent **400**
  - цена: 100 W · 30 S · 640 I
  - score=500
  - produces: —
...
- **Базовый вариант** (19/21): **alg** Алжир, **aus** Австрия, **bav** Бавария, **den** Дания, **eng** Англия … (+14)
  - HP **40000**, buildtime **245.94** игр. с, costpercent **200**
...
- **Базовый вариант** (17/21): **aus** Австрия, **bav** Бавария, **den** Дания, **eng** Англия, **fra** Франция … (+12)
  - HP **4500**, buildtime **312.5** игр. с, costpercent **100**
  - цена: 4900 W · 1700 S
  - score=500
  - produces: archerdip, archerturdip, cossacksichdip, dragoon18dip, grenadierdip, lightcavalrydip, lightinfantrydip, roundshierdip

- **Отклонение 1** (2/21): **alg** Алжир, **tur** Турция
  - HP **5500**, buildtime **312.5** игр. с, costpercent **100**
  - цена: 4600 W · 2020 S
  - score=500
  - produces: archerdip, archerturdip, cossacksichdip, dragoon18dip, grenadierdip, lightcavalrydip, lightinfantrydip, roundshierdip

- **Отклонение 2** (1/21): **rus** Россия
  - HP **6500**, buildtime **312.5** игр. с, costpercent **100**
  - цена: 7900 W · 3700 S
  - score=500
  - produces: archerdip, archerturdip, cossacksichdip, dragoon18dip, grenadierdip, lightcavalrydip, lightinfantrydip, roundshierdip

- **Отклонение 3** (1/21): **ukr** Украина
  - HP **5000**, buildtime **312.5** игр. с, costpercent **100**
  - цена: 3900 W · 2700 S
  - score=500
  - produces: archerdip, archerturdip, cossacksichdip, dragoon18dip, grenadierdip, lightcavalrydip, lightinfantrydip, roundshierdip
...
- **Отклонение 1** (2/21): **alg** Алжир, **tur** Турция
  - HP **5000**, buildtime **93.75** игр. с, costpercent **300**
  - цена: 1000 W · 1200 S · 500 I
  - score=500
  - produces: mullah, padre, pope, priest

- **Отклонение 2** (1/21): **fra** Франция
  - HP **6000**, buildtime **312.5** игр. с, costpercent **300**
...
- **Отклонение 4** (1/21): **ukr** Украина
  - HP **5300**, buildtime **156.25** игр. с, costpercent **300**
...
- **Базовый вариант** (20 наций): **alg** Алжир, **aus** Австрия, **bav** Бавария, **den** Дания, **eng** Англия … (+15)
  - HP **20**, цена: 15 G, buildtime **1.25** игр. с, speed 32
...
- **Базовый вариант** (15 наций): **aus** Австрия, **bav** Бавария, **den** Дания, **fra** Франция, **hun** Венгрия … (+10)
  - HP **100**, цена: 50 F · 30 G, buildtime **6.0** игр. с, speed 32
  - score=10

- **Отклонение 1** (1 нация): **rus** Россия
  - HP **100**, цена: 90 F · 15 G, buildtime **6.0** игр. с, speed 32
  - score=10

### `pikeman` — Лёгкая пехота

- **Базовый вариант** (12 наций): **aus** Австрия, **bav** Бавария, **den** Дания, **eng** Англия, **fra** Франция … (+7)
  - HP **90**, цена: 25 F · 3 G · 20 I, buildtime **4.5** игр. с, speed 32
  - score=10
...
- **Отклонение 1** (1 нация): **spa** Испания
  - HP **100**, цена: 35 F · 7 G · 30 I, buildtime **5.5** игр. с, speed 32
  - score=10
...
- **Базовый вариант** (20 наций): **alg** Алжир, **aus** Австрия, **bav** Бавария, **den** Дания, **eng** Англия … (+15)
  - HP **75**, цена: 12 G, buildtime **1.5** игр. с, speed 32
  - score=1
